...
class Client:
    ...
    def process_read(self, command_elements: List):
        if len(command_elements) == 2:
            ...
            if response.status_code == 200:
                with open(command_elements[1], 'wb') as f:
